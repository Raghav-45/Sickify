...
function App() {
  ...
  return (
    <div className='h-[100vh] bg-center bg-dark'>
      <div className='flex text-white h-auto w-full px-2 pt-2 pb-1'>
      ...
      <MusicCard Name='raghav' Artist='Bro' Image='https://lh3.googleusercontent.com/a/AEdFTp7pvJ8QlLi9q9I_lHMylrsWyDuaZODMG6i2hKdH=s83-c-mo' />
