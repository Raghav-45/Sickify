...
export const ArtistCard = ((props) => {
  ...
  return (
    <div className='relative flex-none group p-2 w-32'>
      <div className='bg-light w-full h-auto p-4 rounded-xl shadow-md'>
        ...
        <h1 className='text-sm text-white font-semibold tracking wide whitespace-nowrap overflow-x-hidden text-ellipsis text-center'>{Name}</h1>
      </div>
    </div>
  )
})
